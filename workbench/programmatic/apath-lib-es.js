...
(function (Adt) {
    ...
    Adt["VariableBindingParam"] = "VariableBindingParam";
...
function peg$parse(input, options) {
    ...
    var peg$e60 = peg$literalExpectation("e", true);
    var peg$e61 = peg$literalExpectation("0x", true);
    var peg$e62 = peg$classExpectation([["0", "9"], ["a", "f"]], false, true);
    ...
    var peg$e70 = peg$literalExpectation("b", false);
    var peg$e71 = peg$literalExpectation("f", false);
    var peg$e72 = peg$literalExpectation("n", false);
    var peg$e73 = peg$literalExpectation("r", false);
    var peg$e74 = peg$literalExpectation("t", false);
    var peg$e75 = peg$literalExpectation("v", false);
    var peg$e76 = peg$classExpectation([["0", "9"], "u", "x"], false, false);
    var peg$e77 = peg$literalExpectation("x", false);
    var peg$e78 = peg$literalExpectation("u", false);
    ...
    var peg$f46 = function () { return { type: "Literal", value: null }; };
    ...
    var peg$f48 = function () { return { type: "Literal", value: true }; };
    var peg$f49 = function () { return { type: "Literal", value: false }; };
    var peg$f50 = function (literal) {
        return literal;
    };
    var peg$f51 = function (literal) {
        return literal;
    };
    ...
    var peg$f64 = function (sequence) { return sequence; };
    var peg$f65 = function () { return ""; };
    var peg$f66 = function () { return "\0"; };
    var peg$f67 = function () { return "\b"; };
    var peg$f68 = function () { return "\f"; };
    var peg$f69 = function () { return "\n"; };
    var peg$f70 = function () { return "\r"; };
    var peg$f71 = function () { return "\t"; };
    var peg$f72 = function () { return "\v"; };
    ...
    var peg$f77 = function () { return loc(w_loc, location()); };
    ...
    function peg$parseIdentifierName() {
        ...
        if (s0 === peg$FAILED) {
            s0 = peg$currPos;
            if (input.charCodeAt(peg$currPos) === 10096) {
                s1 = peg$c34;
                peg$currPos++;
            }
            else {
            ...
            if (s1 !== peg$FAILED) {
                ...
                if (s2 !== peg$FAILED) {
                    ...
                    if (input.charCodeAt(peg$currPos) === 10097) {
                        s4 = peg$c35;
                        peg$currPos++;
                    }
                    else {
...
class Parser {
    ...
    parse(source) {
        try {
            ...
            const e = error;
            throw new ParseError(error.format([{ text: source }])
                .replace('--> undefined:', 'at (line:column) ')
                .replace(/ but .*? found/, '') + '\n', [{ kind: 'errors', location: e.location, message: e.message }]);
        }
    }
}
...
class AstChecker {
    sfman;
    result = { errors: false, warnings: false, var_binds: new Set(), func_defs: [] };
    issues = [];
    constructor(sfman) {
        this.sfman = sfman;
        // if (sfman === undefined) sfman = new StepFuncManager()
    }
    /**
     * invokes all processors
     */
    process(root) {
        const a = this.process_step_funcs(root);
        const b = this.process_vars(root);
        return a && b;
    }
    // pattern:
    // trav(root,
    ...
    */
    process_step_funcs(root) {
        ...
        trav(root, (expr, stk) => {
            if (expr.type === Adt.ApathFuncDef) {
                ...
                if (stk.size() > 1) {
                    ok = false;
                    this.add_issue('errors', expr, `step function '${expr.name}' must defined at top level`);
                }
                let params = [];
                ...
                if (ok) {
                    this.result.func_defs.push({ name: expr.name, params });
                }
            }
    ...
    process_vars(root) {
        ...
        trav(root, expr => {
            ...
            if (expr.type === Adt.VariableBindingNode
                || expr.type === Adt.VariableBinding || expr.type === Adt.VariableBindingParam) {
                ...
                if (!vdecl) {
                    ...
                    this.result.var_binds.add({ name: vname, in_type: expr.type });
                }
                else {
                    expr.data = {
                        ...expr.data,
    ...
    add_issue(kind, expr, message) {
        this.result[kind] = true;
        this.issues.push({
            kind,
            message,
            location: expr.loc ? expr.loc : unknown_loc
        });
    }
    gather_issues(kind) {
        let messages = [];
...
class Apath {
    ...
    ast = empty;
    /** side effect at parsing: not thread-save wrt. member */
    ast_checker;
    ...
    transpile(s, dynart_setting) {
        try {
            ...
            this.ast_checker = Apath.check_ast(ast, fresh_sfman);
            // side effect for testing and utils
            this.ast = ast;
            this.warnings = this.ast_checker.gather_issues('warnings');
     ...
     * @param w_exc =true throws exception if errors
     * @returns message strings
     */
    static check_ast(ast, sfman, w_exc = true) {
        const ast_checker = new AstChecker(sfman);
        if (!ast_checker.process(ast)) {
            if (w_exc && ast_checker.result.errors)
                throw new AnalyseError(ast_checker.gather_issues('errors').toString(), ast_checker.issues);
        }
