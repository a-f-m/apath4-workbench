(function (fs, path) {
    ...
    function peg$parse(input, options) {
        ...
        var peg$e74 = peg$classExpectation([["0", "9"], "u", "x"], false, false);
        var peg$e75 = peg$literalExpectation("x", false);
        var peg$e76 = peg$literalExpectation("u", false);
...
;)`,
            ...
            },
            {
                ...
                kind: 'function',
                snippet: {
                    insertText: `func f(\${1:\u2026formal_parameter_list\u2026}) = (
    \${2:\u2026expression\u2026}
)`,
    ...
    function get_suggestions(enclosing_paren = false, input_symbol, string_to_pos, skip_nl = false) {
        if (input_symbol && input_symbol.match("`|'|/"))
            return [];
        console.log('string_to_pos: ', string_to_pos); //log
        return suggestion_spec.suggestions
            .filter(sugg => sugg.leading_regex ? string_to_pos.match(sugg.leading_regex) : true)
            .map((sugg) => {
